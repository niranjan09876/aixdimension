...
const projects = [
  { title: "FinanceFlow", desc: "AI-powered financial dashboard for enterprise clients", color: "from-primary to-secondary", span: "md:col-span-2", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80" },
